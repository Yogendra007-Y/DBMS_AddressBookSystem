...
VALUES (101,'Yogendra','Sharma','Sagar park','Jalgaon','Maharashtra',425001,'8708095441','paresh@email'),
       (102,'Kritika','Sharma','Adarsh nagar','Jalgaon','Maharashtra',425001,'987654321','sakshi@email'),
       (103,'Sumit','Ware','Aryan park','Jalgaon','Maharashtra',425001,'9786542315','animesh@email'),
       (104,'Zeenat','Khan','Sagar park','Jalgaon','Maharashtra',425001,'9564984532','snehal@email'),
       (105,'Rahul','Gupta','Inner ring road','Indore','Madhya Pradesh',425001,'123456789','nakul@email');
SELECT * FROM address_book;

#UC4
UPDATE address_book
SET Address = 'Ghodbunder area'
WHERE Fname = 'Snehal';
SELECT * FROM address_book;

#UC5
INSERT INTO address_book (Id, Fname, Lname, Address, City, State, Pin, Mobile, Email)
VALUES (106,'Vandana','Singh','Area','City','State',425001,'1238529637','name@email');
SELECT * FROM address_book;
...
UPDATE address_book SET address_book_name = 'AB1' WHERE Fname = 'Vishal' OR Fname = 'Snehal';
UPDATE address_book SET address_book_name = 'AB2' WHERE Fname = 'Salim' OR Fname = 'Animesh';
UPDATE address_book SET address_book_name = 'AB3' WHERE Fname = 'NirajS';
